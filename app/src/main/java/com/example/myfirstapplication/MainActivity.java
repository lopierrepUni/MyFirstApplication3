...
//                    localizaciones();
    ...
    public void marcarLocsHist(final User user, long fechaI, long fechaF){
        ...
        Log.d("Tamaño osm.getoverlays", "El tamaño es: "+String.valueOf(osm.getOverlays().size()));
    ...
    public void addMarkerHist(String time, String latitud, String longitud, String name) {
        ...
        marker.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                ...
                Log.d("Confirmación: ", "Usuario Seleccionado");
                Log.d("Confirmación: ", String.valueOf(selectedUser.getId()));
                return false;
            }
